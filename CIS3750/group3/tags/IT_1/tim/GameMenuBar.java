...
public class GameMenuBar extends JMenuBar
{
	...
	public void setConfigMenus()
	{
		...
		JMenuItem cfgGrav = new JMenuItem("Gravity",KeyEvent.VK_G);
		cfgGrav.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_G, Event.META_MASK));
		cfgGrav.getAccessibleContext().setAccessibleDescription("This adjusts the gravity");
		cfgGrav.addActionListener(this.theListener);

		JMenuItem cfgAir = new JMenuItem("Air Pressure", KeyEvent.VK_A);
		cfgAir.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A, Event.META_MASK));
		cfgAir.getAccessibleContext().setAccessibleDescription("This adjusts the air pressure");
		cfgAir.addActionListener(this.theListener);
	...
	public void setHelp()
	{
		...
		hlpHelp.addActionListener(this.theListener);
		...
		hlpAbout.addActionListener(this.theListener);
