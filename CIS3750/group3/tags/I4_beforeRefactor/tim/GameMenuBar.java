...
public class GameMenuBar extends JMenuBar
{
	...
	public void setFileMenus()
	{
		...
		open.addActionListener(new ActionListener() {
			...
			{
				FileDialog fd = new FileDialog(GameWindow.getInstance(), "Load level");
				fd.setFilenameFilter(new FFXML());
				fd.show();

				if(fd.getFile() != null)
				{
					boolean bSuccess = LevelLoader.load(fd.getDirectory()+fd.getFile());
				}
			}
		});
