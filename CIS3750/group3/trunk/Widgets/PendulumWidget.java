...
public class PendulumWidget implements Widget
{
	...
	public ImageIcon getIcon( )
	{
		/* create a new icon with the image of the widget */
		  ...
		  return new ImageIcon("resources/icons/widgets/pendulum_thumb.png");
		
		/* using this.getClass().getResource("./").getFile().toString() to get the 
		 * current working directory for the icon 
		 * 
		...
		//return new ImageIcon( this.getClass().getResource("./").getFile().toString() + "/pendulum_thumb.png" );
	}
	...
	public void resetWidget( )
	{
		...
		//this.bodyList[0].set( shape, m );
		this.bodyList[1].set( new Circle(this.ballSize), 140 );
		this.setPosition( new Vector2f(this.getPositionX(), this.getPositionY()) );
