...
public class WidgetPanelButton extends JButton implements ActionListener
{
	 ...
	 *
	 */
	public WidgetPanelButton(Widget inW, int inNumStack, GameController c)
	{
		super(inW.getIcon());
	...
	public WidgetPanelButton(Widget inW, GameController c)
	{
		this(inW, 1, c);
	}
	...
	{
		System.out.println("Selected item: " + w.getName() + " >>>> " + w );
		controller.setSelectedPiece( w );
